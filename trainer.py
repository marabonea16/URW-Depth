                    ...
                    wandb.log(
                        {
                            ...
                            "batch": int(batch_idx),
                            "train/loss_HiS": float(losses["loss_HiS"].detach().cpu().item()),
                            "train/loss_MiS": float(losses["loss_MiS"].detach().cpu().item()),
                            "train/loss_LoS": float(losses["loss_LoS"].detach().cpu().item()),
                            "train/loss_consis_HiS": float(losses["loss_consis_HiS"].detach().cpu().item()),
                            "train/loss_consis_LoS": float(losses["loss_consis_LoS"].detach().cpu().item()),
                            "train/loss_total": float(losses["loss"].detach().cpu().item()),
